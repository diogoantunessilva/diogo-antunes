...
const signals = [
  {
    date: "13/03/2026",
    title: "Excel ",
    note: "Planilhas de analises de clientes a partir de comandos procv e base de dados.",
  },

  {
    date: "13/04/2026",
    title: "Python",
    note: "Automações de captura de comandos via SSH e utilização do MobaXterm como gerador de arquivos txt durante o uso da sessão.",
  },
  {
    date: "13/04/2026",
    title: "Zabbix",
    note: "Automações de monitoramento e alertas para infraestrutura de rede usando Zabbix.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / Plataformas utilizadas</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">Em desenvolvimento</h2>
      </div>
